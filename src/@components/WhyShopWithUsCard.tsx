...
const WhyShopWithUsCard: React.FC<IProps> = ({ className, feature }) => {
  return (
    ...
    >
      <div className="p-2 rounded-full bg-gray-50 group-hover:bg-gray-100 dark:bg-[var(--color-dark-gray)] dark:group-hover:bg-[var(--color-dark-gray)] transition w-32 h-32 flex justify-center items-center mx-auto">
