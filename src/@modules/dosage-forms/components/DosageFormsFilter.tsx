...
import { IDosageFormsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IDosageFormsFilter;
  onChange: (values: IDosageFormsFilter) => void;
}

const DosageFormsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
...
export default DosageFormsFilter;
