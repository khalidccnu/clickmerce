...
import { IBannersFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IBannersFilter;
  onChange: (values: IBannersFilter) => void;
}

const BannersFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
