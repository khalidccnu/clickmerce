...
import { ICouponsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: ICouponsFilter;
  onChange: (values: ICouponsFilter) => void;
}

const CouponsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
        ...
        >
          <Form.Item name="type" className="!mb-0">
            <FloatSelect
              ...
              options={couponTypes.map((couponType) => ({
                key: couponType,
                label: Toolbox.toPrettyText(couponType),
                value: couponType,
              }))}
            />
          </Form.Item>
