...
import { IFeaturesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IFeaturesFilter;
  onChange: (values: IFeaturesFilter) => void;
}

const FeaturesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
