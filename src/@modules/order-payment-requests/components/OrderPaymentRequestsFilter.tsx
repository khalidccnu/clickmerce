...
import { IOrderPaymentRequestsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IOrderPaymentRequestsFilter;
  onChange: (values: IOrderPaymentRequestsFilter) => void;
}

const OrderPaymentRequestsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
...
export default OrderPaymentRequestsFilter;
