...
import { IDeliveryServiceTypesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IDeliveryServiceTypesFilter;
  onChange: (values: IDeliveryServiceTypesFilter) => void;
}

const DeliveryServiceTypesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
...
export default DeliveryServiceTypesFilter;
