...
import { IDeliveryServiceTypeCreate } from '../lib/interfaces';

interface IProps {
  isLoading: boolean;
  form: FormInstance;
  formType?: 'create' | 'update';
  initialValues?: Partial<IDeliveryServiceTypeCreate>;
  onFinish: (values: IDeliveryServiceTypeCreate) => void;
}

const DeliveryServiceTypesForm: React.FC<IProps> = ({
  isLoading,
  form,
  formType = 'create',
  initialValues,
...
export default DeliveryServiceTypesForm;
