...
import { INoticesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: INoticesFilter;
  onChange: (values: INoticesFilter) => void;
}

const NoticesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
