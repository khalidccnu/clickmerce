...
import { IGenericsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IGenericsFilter;
  onChange: (values: IGenericsFilter) => void;
}

const GenericsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
